# scratch/sim_bootsec/dataSizeSum_60_100_norm.gnu

reset session # clear gnuplot previous config

output_file="../../results/dataSizeSum_60_100_norm.pdf"
data_path= "../../results/dataSizeSum_60_100_norm.dat"
...
# ---- PLOTAGEM ----
plot \
     data_path using (100*$5/($2+$3+$4+$5)) ls 4 t 'SIGN', \
     data_path using (100*$4/($2+$3+$4+$5)) ls 3 t 'KEY', \
     data_path using (100*$3/($2+$3+$4+$5)) ls 2 t 'SCHEMA', \
     data_path using (100*$2/($2+$3+$4+$5)):xtic(1) ls 5 t 'PAYLOAD'
