# scratch/sim_bootsec/dataQtdSum_60_100_norm.gnu

reset session # clear gnuplot previous config

output_file="../../results/dataQtdSum_60_100_norm.pdf"
data_path= "../../results/dataQtdSum_60_100_norm.dat"
...
set ylabel "Data Packets Received [%]"
...
# ---- PLOTAGEM ----
plot \
     data_path using 4:xtic(1) ls 4 t 'SIGN', \
     ''          using 3 ls 3 t 'KEY', \
     ''          using 2 ls 2 t 'SCHEMA'
