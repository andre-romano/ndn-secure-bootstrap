...
namespace ns3 {
    namespace ndn {
                ...
                TypeId("CustomProducer")
                    ...
                    .AddAttribute(
                        ...
                        MakeUintegerAccessor(
                            &CustomProducer::m_virtualPayloadSize
                        ),
                    ...
                    .AddAttribute(
                        "IdentityPrefix", "Name of the Identity of the App",
                        StringValue(""),
                        MakeNameAccessor(&CustomProducer::m_identityPrefix),
                        MakeNameChecker()
                    );
        ...
        void CustomProducer::OnInterestKey(
            ...
            auto cert = std::make_shared<::ndn::security::v2::Certificate>(
        ...
        void CustomProducer::OnInterestContent(
            std::shared_ptr<const ndn::Interest> interest
        ) {
            // NS_LOG_FUNCTION(interest->getName());
        ...
        CustomProducer::createCertificate() {
            ...
            try {
                ...
                m_keyChain.deleteIdentity(
                    m_keyChain.getPib().getIdentity(m_identityPrefix)
                );
            ...
            ); ///< define the default Data packet signer
        ...
        void CustomProducer::loadCertificateTrustAnchor() {
            NS_LOG_DEBUG(
                "TrustAnchor: " << m_trustAnchorIdentityPrefix
                                << " - CertFilename: "
                                << m_trustAnchorCertFilename
            );
            auto rootIdentity =
                m_keyChain.createIdentity(m_trustAnchorIdentityPrefix);
            auto rootKey = rootIdentity.getDefaultKey();
            m_keyChain.deleteKey(rootIdentity, rootKey);

            auto newCert = ::ndn::io::load<::ndn::security::v2::Certificate>(
                m_trustAnchorCertFilename
            );
            auto keyParams =
        ...
        void CustomProducer::setSignCallback(
            std::function<::ndn::security::v2::Certificate(
